...
// ✅ Save todos, history & theme whenever they change
watch([todos, history, theme], () => {
    ...
    <main class="p-4 max-w-xl mx-auto space-y-6">
      ...
      <section v-if="history.length" class="mt-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg shadow">
        <button 
          ...
          class="w-full px-3 py-2 mb-2 rounded bg-blue-500 text-white font-medium" >
        ...
        <transition name="fade">
          <div v-if="showHistory">
            ...
            <ul class="space-y-2">
              <li v-for="(task, i) in history" :key="i" 
                  class="text-sm text-gray-700 dark:text-gray-300 flex justify-between">
                <span>{{ task.text }}</span>
